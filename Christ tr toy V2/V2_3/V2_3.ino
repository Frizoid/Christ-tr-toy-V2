...
0xA4, 0xCC, 0xA4, 0xBA, 0x25, 0x72, 0x60,
0xAA, 0xAA, 0xA4, 0xA2, 0xA5, 0x45, 0x50,
0xAA, 0xAA, 0x44, 0xA2, 0xA2, 0x45, 0x50,
0xEE, 0xCC, 0x46, 0xBA, 0xA2, 0x77, 0x60,
0xAA, 0x88, 0x47, 0xA2, 0xA2, 0x45, 0x50,
0xAA, 0x88, 0x45, 0xA2, 0xA2, 0x45, 0x50,
0xAA, 0x88, 0x44, 0xB9, 0x42, 0x75, 0x50
};
...
void loop()
{
  switch (mode)
  {
    case 0: scrollBitmap(bitmap_40x7, 5, 7, 1);break;
    ...
    case 8: scrollBitmap(bitmap_40x7, 5, 7, 1);break;
  }
  offs++;
  if (++mcount > 41)
  {
